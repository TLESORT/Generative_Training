...
def plot_tau_training(save_dir, dataset, model_name):
    ...
    for j in liste:
        ...
        # Load baseline gauss
        name2 = os.path.join(save_dir, dataset, 'Classifier', 'num_examples_' + j, 'best_score_classif_sigma_0.125' + dataset + '.txt')
...
def plot_num_training(saveDir, dataset):
    ...
    # save_dir=[]
    liste_model = ["VAE", "WGAN"]  # ,"Classifier","WGAN","VAE","ACGAN"]
    liste = ["100", "500", "1000", "5000", "10000", "60000"]
    liste_classif = ["100", "500", "1000", "5000", "10000", "50000"]
    liste2=[100,500,1000,5000,10000,500000]
    ...
    for j in liste_classif:
        ...
        baseline.append(np.array(np.loadtxt(name2)).max())
        # Load baseline gauss
        name2 = os.path.join(saveDir, dataset, 'Classifier', 'num_examples_' + j, 'best_score_classif_sigma_0.125' + dataset + '.txt')
        baseline_gaussien.append(np.array(np.loadtxt(name2)).max())
...
#plt.clf()
#plot_tau_training('models','mnist','WGAN')
#plt.clf()
#plot_tau_training('models','fashion-mnist','VAE')
#plt.clf()
#plot_tau_training('models','fashion-mnist','WGAN')
#plt.clf()
plot_num_training('models', 'mnist')
plt.clf()
plot_num_training('models', 'fashion-mnist')
